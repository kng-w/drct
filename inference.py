...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default=  # noqa: E251
        "/workspace/models/DRCT_XL.pth"  # noqa: E501
    )
    parser.add_argument('--input', type=str, default='/workspace/data/test_input', help='input test image folder')
    ...
    for idx, path in enumerate(sorted(glob.glob(os.path.join(args.input, '*')))):
        ...
        try:
            ...
            cv2.imwrite(os.path.join(args.output, f'{imgname}_DRCT-L_XL.png'), output)
